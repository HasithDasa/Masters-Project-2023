...
# checking which mask belongs to which Bbox
    ...
    for ele_ind, ele_int_list in enumerate(intersected_masks_list):
        ...
        # img_temp_5 = img_temp_5.astype(np.uint8) * 0
        # img_temp_4 = img_temp_4.astype(np.uint8) * 0
    ...
    #
    #     intersected_masks_name = "final_images/Intersected_mask_%d.jpg" % and_indx
    #     print(intersected_masks_name)
    #     cv2.imwrite(intersected_masks_name, and_elem)
